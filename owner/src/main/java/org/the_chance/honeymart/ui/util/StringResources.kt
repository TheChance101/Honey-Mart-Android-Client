...
class StringResources @Inject constructor(
    ...
    override val errorString: Map<ErrorHandler, String>
        get() = mapOf(
            ErrorHandler.InvalidName to getStringFromFile(R.string.invalid_name),
            ...
            ErrorHandler.MarketNotApproved to getStringFromFile(R.string.market_not_approved),
            ErrorHandler.InvalidOwnerId to getStringFromFile(R.string.invalid_owner),
        )
